package net.mcreator.warforeternity;
...
import net.mcreator.warforeternity.init.WarForEternityModTabs;
import net.mcreator.warforeternity.init.WarForEternityModMenus;
...
@Mod("war_for_eternity")
public class WarForEternityMod {
	public static final Logger LOGGER = LogManager.getLogger(WarForEternityMod.class);
	public static final String MODID = "war_for_eternity";

	public WarForEternityMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		WarForEternityModItems.register(modEventBus);
		WarForEternityModEntities.REGISTRY.register(modEventBus);
		WarForEternityModTabs.REGISTRY.register(modEventBus);
		WarForEternityModVariables.ATTACHMENT_TYPES.register(modEventBus);

		WarForEternityModMenus.REGISTRY.register(modEventBus);
