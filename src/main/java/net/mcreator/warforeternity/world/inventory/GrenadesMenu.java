...
public class GrenadesMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GrenadesMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WarForEternityModMenus.GRENADES.get(), id);
